			...
			<Stack className={styles.answerContainer} tabIndex={0}>
				...
				<Stack horizontal className={styles.answerFooter}>
					...
					<Stack.Item className={styles.answerDisclaimerContainer}>
						<span className={styles.answerDisclaimer}>This is beta AI Content and may be inaccurate. For specific information, please check the<a target='_blank' href="https://laborieonline.sharepoint.com/sites/LaborieLife/SitePages/Human-Resources.aspx" >Laborie HR website</a>which includes the contact for your HR Business Partner.</span>
					</Stack.Item>
